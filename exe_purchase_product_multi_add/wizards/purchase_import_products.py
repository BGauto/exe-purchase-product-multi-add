...
class PurchaseImportProducts(models.TransientModel):
    ...
    def create_items(self):
        ...
        view = self.env.ref("exe_purchase_product_multi_add.view_import_product_to_purchase2")
        return {
    ...
    def _get_line_values(self, purchase, item):
        ...
        purchase_line._product_id_change()
...
class PurchaseImportProductsItem(models.TransientModel):
    ...
    wizard_id = fields.Many2one(string="Wizard", comodel_name="purchase.import.products")
